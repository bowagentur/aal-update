/*
  # Synchronize Hotel Data Structure
  
  1. Changes
    - Add missing fields to match hotels.ts structure
    - Update data types to match TypeScript interfaces
    - Ensure all nested data is properly stored
    
  2. Data Organization
    - Sections with complete metadata
    - Room types with all amenities
    - Policies with full configuration
*/
  ...
  INSERT INTO hotel_sections (hotel_id, type, title, content, metadata) VALUES
    ...
    (hotel_id, 'dining', 'Restaurant & Bar',
     ...
     '{
       ...
       "description": "Das Restaurant und die Außenterrasse laden ein zum ausgiebigen Frühstück, einem leichten Mittagessen, Kaffee und Kuchen oder einem Dinner am Abend.",
       "restaurants": [
         {
    ...
    (hotel_id, 'meetings', 'Tagen im Hotel Rheinpark Rees',
     ...
     '{
       ...
       "description": "Alle Räume haben Tageslicht, verfügen über modernste Informations- und Kommunikationstechnik und sind teils klimatisiert.",
       "highlights": [
    ...
    -- Location section
    (hotel_id, 'location', 'Lage & Anreise',
     'Entdecken Sie die historische Stadt Rees mit ihrer charmanten Rheinpromenade und den historischen Stadtmauern.',
     '{
       "description": "Unser Hotel liegt ideal für Ausflüge in die Region, sei es mit dem Fahrrad entlang des Rheinradwegs oder zu den nahegelegenen Städten wie Emmerich, Kleve oder Xanten.",
       "access": {
         "car": "A3 (Arnheim-Köln)",
         "airports": [
           {
