/*
  # Import hotel data from data/hotels.ts

  1. Changes
    - Import all hotel data including sections, rooms, amenities, etc.
    - Preserve all relationships and nested data
    - Maintain data structure and types

  2. Data Organization
    - Hotels with all metadata
    - Sections with content and metadata
    - Rooms with amenities and pricing
    - Contacts and policies
*/

-- Function to handle the data import
DO $$
DECLARE
  hotel_id uuid;
BEGIN
